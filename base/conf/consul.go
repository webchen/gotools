...
func ConsulRegister() {
	...
	registration.Port = int(str.Convert2Int32(cnf["register"].(map[string]interface{})["port"]))             // 服务端口
	...
	checkPort := int(str.Convert2Int32(cnf["check"].(map[string]interface{})["port"]))
